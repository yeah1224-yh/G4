...
- [ ] Compatibilité : La plateforme doit être compatible avec Chrome, Brave, Firefox, Safari et les navigateurs mobiles Android/iOS  
...
- Langage principal : java ( javalin) , java script  
